      ...
      <tbody class="list"><tr>
        <td>
          <div class="media align-items-center">
            ...
            <div class="media-body">
              <a class="text-body js-lists-values-course" href="instructor-course-edit.html"><strong>PLANEACION</strong></a><br>
            </div>
          </div>
        </td>
        <td class="text-right">
        ...
        <td>
          <div class="media align-items-center">
            ...
            <div class="media-body">
              <a class="text-body js-lists-values-course" href="instructor-course-edit.html"><strong>LIDERAZGO</strong></a><br>
            </div>
          </div>
        </td>
        <td class="text-right">
        ...
        <td>
          <div class="media align-items-center">
            ...
            <div class="media-body">
              <a class="text-body js-lists-values-course" href="instructor-course-edit.html"><strong>TRABAJO EN EQUIPO</strong></a><br>
            </div>
          </div>
        </td>
        <td class="text-right">
        ...
        <td>
          <div class="media align-items-center">
            ...
            <div class="media-body">
              <a class="text-body js-lists-values-course" href="instructor-course-edit.html"><strong>NEGOCIACION</strong></a><br>
            </div>
          </div>
        </td>
        <td class="text-right">
