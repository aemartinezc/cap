...
@section('main')
  ...
  <div class="d-flex flex-column flex-sm-row flex-wrap mb-headings align-items-start align-items-sm-center">
    ...
    <a href="instructor-quiz-edit.html" class="btn btn-success">Nueva</a>
  </div>
      ...
      <tbody class="list"><tr>
        <td>
          <div class="media align-items-center">
            ...
            <div class="media-body">
              <a class="text-body js-lists-values-course" href="instructor-course-edit.html"><strong>SECERTARIA DE ADMINSTRACION</strong></a><br>
            </div>
          </div>
        </td>
        <td class="text-right">
        ...
        <td>
          <div class="media align-items-center">
            ...
            <div class="media-body">
              <a class="text-body js-lists-values-course" href="instructor-course-edit.html"><strong>SECRETARIA DE BIENESTAR SOCIAL</strong></a><br>
            </div>
          </div>
        </td>
        <td class="text-right">
        ...
        <td>
          <div class="media align-items-center">
            ...
            <div class="media-body">
              <a class="text-body js-lists-values-course" href="instructor-course-edit.html"><strong>SECRETARIA DEL TRABAJO</strong></a><br>
            </div>
          </div>
        </td>
        <td class="text-right">
        ...
        <td>
          <div class="media align-items-center">
            ...
            <div class="media-body">
              <a class="text-body js-lists-values-course" href="instructor-course-edit.html"><strong>SECRETARIA DE FINANZAS</strong></a><br>
            </div>
          </div>
        </td>
        <td class="text-right">
