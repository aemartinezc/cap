...
@section('main')
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="student-dashboard.html">Inicio</a></li>
        ...
        <div class="tab-pane active" id="first">
          <form action="#" class="form-horizontal">
            <div class="form-group row">
              <label for="avatar" class="col-sm-3 col-form-label form-label">Imagen</label>
              <div class="col-sm-9">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <div class="row">
                  <div class="col-md-6">
                    <input id="name" type="text" class="form-control" placeholder="First Name" value="{{  Auth::user()->name}}">
                  </div>
                </div>
              </div>
            </div>
            <div class="form-group row">
              <label for="email" class="col-sm-3 col-form-label form-label">Correo</label>
              <div class="col-sm-6 col-md-6">
                <div class="input-group">
                  ...
                  <input type="text" id="email" class="form-control" placeholder="Email Address" value="{{  Auth::user()->email}}" disabled="">
                </div>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-6 col-md-4">
                <div class="input-group">
                  ...
                  <input type="password" id="password" class="form-control" placeholder="Escribe nuevo password">
                </div>
              </div>
            </div>
            <div class="form-group row">
